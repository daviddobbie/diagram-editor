...
public class ZigZagLine implements LineInterface
{    
    private double x1;
    private double y1;
    private double x2;
     ...
     */
    public ZigZagLine(Shape s1, Shape s2, String t)
    {
        shape1 = s1;
        shape2 = s2;
        text = t;
    ...
    public void draw(){
        ...
        double xStep = (xHigh - xLow)/30;
        double yStep = (yHigh - yLow)/30;

        for(int i = 0; i < 30; i++){
            UI.drawLine(xLow + xStep * i, yLow + yStep * i, xLow + xStep * (i+1), yLow + yStep * i);
            UI.drawLine(xLow + xStep * (i+1),  yLow + yStep * i, xLow + xStep * (i+1), yLow + yStep * (i+1));
        }
    ...
    public String toString(){
        String s = "ZigZagLine " + text + " \" " + shape1.toString() + " " + shape2.toString();
        return s;
    }
